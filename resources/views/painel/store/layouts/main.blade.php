...
<html lang="en">
  ...
  <!--TOastr-->
    ...
    <link href="{{asset('painel/vendors/bootstrap-select/css/bootstrap-select.min.css')}}" rel="stylesheet">
  </head>
  ...
  <body class="nav-md">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('admin')}}">Site</a></li>
                    </ul>
                  </li>
                  <li><a href="{{url('admin/loja/pedidos')}}"><i class="fa fa-shopping-cart"></i> Pedidos</span></a>
                  
                  </li>
                  <li><a><i class="fa fa-desktop"></i>Produtos<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('admin/loja/produtos')}}">Todos os produtos</a></li>
                      <li><a href="{{url('admin/loja/produtos/adicionar')}}">Adicionar novo</a></li>
                      <li><a href="{{url('admin/loja/categorias')}}">Categorias</a></li>
    ...
    <!-- Datatables -->
    <script src="{{asset('painel/vendors/datatables.net/js/jquery.dataTables.js')}}"></script>
    ...
    <script src="{{asset('painel/vendors/bootstrap-select/js/bootstrap-select.js')}}"></script>
